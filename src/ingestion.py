...
def run_ingestion():
    ...
    # 4. Inicjalizacja modelu Embeddingów
    ...
    print(f"Batch size: {BATCH_SIZE} | Opóźnienie: {DELAY_BETWEEN_BATCHES}s")
    print(f"Free tier API - to może potrwać ~{len(chunks) // BATCH_SIZE * DELAY_BETWEEN_BATCHES // 60 + 1} minut\n")
